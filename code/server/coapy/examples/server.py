...
class AcknowledgeTempService (coapy.link.LinkValue):

    def process (self, rx_record):
        msg = coapy.connection.Message(coapy.connection.Message.ACK, code=coapy.OK, payload="Ja, jag fick ditt message")
        rx_record.ack(msg)
...
services.add_service(AcknowledgeTempService('temp'))
