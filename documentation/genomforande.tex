...
My main task during the first sprint was to understand how the library jcoap worked, eventually when I understood jcoap somewhat I tried together with William to make i work together with bluetooth.
Not knowing how anything worked made it almost impossible to make a good estimations of how long tasks will take to complete.
Eventually when we scraped our attempts to send coap over bluetooth in the beginning if sprint two, there were no longer any major problems to send an empty coap packet.
...
There has been many smaller fixes, things to learn how it works and other minor issues that has been difficult to write down as a scrum-point.
...
Another thing i would like is to be better at dividing the big tasks into smaller tasks, something a clear program structure  would have made it a lot easier to do
